...
- Updated directory structure
    - Updated directory dev to resources
    - Updated custom variable files to a theme directory structure
- Updated build directory
- Updated package
...
- Updated build directory
- Updated package
    - Updated devDependencies just-add-juice version to 0.16.2-beta


-----


# February 11, 2019 (Juice v0.16.1-beta)
...
# January 16, 2019 (Juice v0.14.0-beta)

### Updated
- Updated build directory
- Updated package
    - Updated devDependencies just-add-juice version to 0.14.0-beta
